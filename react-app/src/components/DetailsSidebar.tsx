            ...
            <div style={{ marginBottom: '20px' }}>
              ...
              {isEditing ? (
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  ...
                  <span style={{ color: theme.colors.onSurface, fontWeight: '500' }}>{goal.title}</span>
                  <Badge 
                    style={{ 
                      backgroundColor: themeColor, 
                      color: 'white',
                ...
                <span style={{ color: theme.colors.onSurface }}>No goal linked</span>
              )}
            </div>
          </>
        )}
          ...
          <>
            <Row style={{ marginBottom: '20px' }}>
              <Col xs={6}>
                ...
                {isEditing ? (
                  ...
                  <Badge bg="outline-secondary" style={{ fontSize: '12px', padding: '6px 12px', border: `1px solid ${theme.colors.border}` }}>
                    {(item as Task).effort}
                  </Badge>
                )}
              </Col>
            ...
            <div style={{ marginBottom: '20px' }}>
              ...
              {isEditing ? (
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  ...
                  <span style={{ color: theme.colors.onSurface, fontWeight: '500' }}>{story.title}</span>
                </div>
              ) : (
                <span style={{ color: theme.colors.onSurface }}>No parent story</span>
              )}
            </div>
            ...
            <div style={{ marginBottom: '20px' }}>
              ...
              {isEditing ? (
                ...
                <span style={{ color: theme.colors.onSurface }}>No due date set</span>
              )}
            </div>
          </>
        )}
