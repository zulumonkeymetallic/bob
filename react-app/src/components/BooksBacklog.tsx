  ...
  return (
    <Card className="border-0 shadow-sm">
      <Card.Header className="bg-white d-flex flex-wrap gap-3 align-items-center justify-content-between">
        ...
        <div className="d-flex flex-wrap gap-2 align-items-center">          <Form.Control size="sm" placeholder="Search books" value={search} onChange={(e) => setSearch(e.target.value)} style={{ width: 200 }} />
